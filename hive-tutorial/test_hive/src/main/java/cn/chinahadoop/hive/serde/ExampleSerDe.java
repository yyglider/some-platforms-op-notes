package cn.chinahadoop.hive.serde;
...
public class ExampleSerDe extends AbstractSerDe {

	private static final Log logger=LogFactory.getLog(ExampleSerDe.class);
	// params
	...
	public void initialize(Configuration conf, Properties tbl)
		...
		// Read sep
		logger.info("welcome ExampleSerDe init ............");
		System.out.println("welcome ExampleSerDe init............");
		lineSep = "\n";
		kvSep = "=";
	...
	public Object deserialize(Writable wr) throws SerDeException {
		logger.info("welcome ExampleSerDe deserialize ............");
		System.out.println("welcome ExampleSerDe deserialize............");
		// Split to kv pair
		if (wr == null)
			return null;
	...
	public Writable serialize(Object arg0, ObjectInspector arg1)
			throws SerDeException {
		logger.info("welcome ExampleSerDe serialize ............");
		System.out.println("welcome ExampleSerDe serialize............");
		// Not suppourt yet
		return null;
	}
